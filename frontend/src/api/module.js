...
export const enableAppModule = (appId, moduleCode) => request.post(`/apps/${appId}/modules`, { module_code: moduleCode })
export const updateAppModule = (appId, moduleCode, data) => request.put(`/apps/${appId}/modules/${moduleCode}`, data)
export const disableAppModule = (appId, moduleCode) => request.delete(`/apps/${appId}/modules/${moduleCode}`)
